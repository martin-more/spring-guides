package com.moredev.spring.gsdatarest;
...
import com.moredev.spring.gsdatarest.repository.PersonRepository;
...
public class ApplicationTests {
	...
	public void shouldCreateEntity() throws Exception {
		mockMvc.perform(post("/people").content("{\"firstName\": \"Martin\", \"lastName\":\"More\"}"))
